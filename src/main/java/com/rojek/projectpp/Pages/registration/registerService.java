...
import com.rojek.projectpp.Pages.registration.email.EmailSender;
...
import com.rojek.projectpp.Security.Services.UsersService;
import com.rojek.projectpp.Security.Services.UsersService2;
import com.rojek.projectpp.Security.Services.UsersServiceImpl;
...
public class registerService {
    ...
    public void register(Users user) {
        String token = usersService.saveUser(user);
    ...
    public String confirmToken(String token) {
        ConfirmationToken confirmationToken = confirmationTokenService.getToken(token).orElse(
                 null
        );
